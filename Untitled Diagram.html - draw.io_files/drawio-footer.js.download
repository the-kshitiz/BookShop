...
{rotate(td2,rate,1000,function()
{mxEvent.addListener(td2,'click',mxUtils.bind(this,function()
{td2.innerHTML='<a href="javascript:void(0)">Thanks for your review!</a>';}));});},5000);}
...
{if(last.length>0)
{rotate(td,last.pop());}});window.setTimeout(function()
{rotate(td,(Math.random()<0.5)?like:tweet);},30000);}});