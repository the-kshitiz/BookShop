...
Public Class suppbill
    Public crv As New CrystalReport11
    Private Sub suppbill_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.CenterToScreen()
        ...
        'mydiscvalue.Value = Trim(custsales.TextBox1.Text)
        ...
        myparam = New ParameterField()
        mydiscvalue = New ParameterDiscreteValue()
        myparam.ParameterFieldName = "pid"
        mydiscvalue.Value = purchaseedit.TextBox1.Text
        myparam.CurrentValues.Add(mydiscvalue)
        myparams.Add(myparam)
